...
const Header: React.FC = () => {
    ...
    return (
        <header className="py-10 relative bg-white border-b border-slate-200/80 px-4 sm:px-6 lg:px-8 flex items-center justify-end overflow-hidden">
            
            <h1 className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-xl sm:text-2xl md:text-3xl font-medium text-slate-700 whitespace-nowrap">
                <span className="hidden sm:inline">Your Guide to </span>
                <span className="font-bold text-slate-900 w-[150px] sm:w-[170px] md:w-[200px] inline-block text-left">
                    <span 
                        className={`
